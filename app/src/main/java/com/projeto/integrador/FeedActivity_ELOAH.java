...
public class FeedActivity_ELOAH extends DrawerCreator_ELOAH {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savedInstanceState.putInt("layout", R.layout.telamiolo_ELOAH);
    ...
    private void imprimePropostasGerais() {
        ...
        call.enqueue(new Callback<List<Proposta>>() {
            ...
            public void onResponse(Call<List<Proposta>> call, Response<List<Proposta>> response) {
                ...
                listaPropostas.setAdapter(new PropostaAdapter(FeedActivity_ELOAH.this, listaDePropostasGerais));
            }
    ...
    public void vaiParaMinhasPropostas(View view){
        Intent intent = new Intent(this, PropostasActivity_ELOAH.class);
