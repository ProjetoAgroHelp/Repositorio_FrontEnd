...
public class MainActivity_ELOAH extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_ELOAH);
    }
    ...
    private void chamadaLogin() {
        ...
        call.enqueue(new Callback<Usuario>() {
            ...
            public void onFailure(Call<Usuario> call, Throwable t) {
                Toast.makeText(MainActivity_ELOAH.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
...
//            chamadaLogin();
    ...
    public void abreTelaDeCadastro(View view){
        Intent intent = new Intent(MainActivity_ELOAH.this, CadastroAcitivity_ELOAH.class);
        startActivity(intent);
    }
}
